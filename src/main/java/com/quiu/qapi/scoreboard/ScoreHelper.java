package com.quiu.qapi.scoreboard;
...
public class ScoreHelper {
    ...
    public static ScoreHelper createScore(Player player, DisplaySlot slot) {
        return new ScoreHelper(player, slot);
    }
    ...
    private ScoreHelper(Player player, DisplaySlot slot) {
